...
map("n", "<leader>fs", "<cmd>Telescope grep_project<cr>")
map("n", "<leader>ff", "<cmd>Telescope find_files<cr>")
map("n", "<leader><space>", "<cmd>Telescope lsp_dynamic_workspace_symbols<cr>")
...
-- end
-- end)
map("n", "<CR>", "<cmd>Telescope buffers sort_lastused=True<cr>")
map("n", "<C-l>", "<cmd>bn<cr>")
map("n", "<C-h>", "<cmd>bp<cr>")
